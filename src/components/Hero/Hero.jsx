      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative">
        ...
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10 ">
          <div className=" text-center md:text-left space-y-6 lg:max-w-[400px]">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-5xl lg:text-6xl leading-relaxed font-bold xl:leading-normal font-averia"
            >
              Healthy
              <br />
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-2xl tracking-wide capitalize"
            >
        ...
        <div className="flex justify-center items-center  ">
          <motion.img
            ...
            src={HeroPng}
            className="w-[350px] md:w-[550px] drop-shadow-2xl"
          />
        </div>
